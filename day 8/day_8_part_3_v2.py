...
for elem in new_data:
    ...
    if b[2] == "Standard":
        print(f"{b[0]:<10} {b[1]:<15} {b[2]:<15} {b[3]:<15} {b[4]:<15}")
        summa_standard += float(b[4])

print()
print(f"{'Total (Standard)':.<58} {summa_standard:.2f}")
...
for elem in new_data:
    ...
    if b[2] == "First":
        print(f"{b[0]:<10} {b[1]:<15} {b[2]:<15} {b[3]:<15} {b[4]:<15}")
        summa_first += float(b[4])
print()
print(f"{'Total (First)':.<58} {summa_first:.2f}")
...
for elem in new_data:
    ...
    if b[2] == "Second":
        print(f"{b[0]:<10} {b[1]:<15} {b[2]:<15} {b[3]:<15} {b[4]:<15}")
        summa_second += float(b[4])
print()
print(f"{'Total (Second)':.<58} {summa_second:.2f}")
